...
class Explore extends React.PureComponent {
  ...
  static propTypes = {
    ...
    isLoadingHashtags: PropTypes.boolean,
    isLoadingLinks: PropTypes.boolean,
  };
  ...
  render () {
    const { intl, columnId, multiColumn, hashtags, isLoadingHashtags, links, isLoadingLinks, suggestions } = this.props;
      ...
      <Column bindToDocument={!multiColumn} ref={this.setRef} label={intl.formatMessage(messages.title)}>
        ...
        <div className='scrollable'>
          <div className='account__section-headline'>
            ...
            <button className={classNames({ active: index === 2 })} data-index={2} onClick={this.handleChangeIndex}><FormattedMessage id='explore.suggested_follows' defaultMessage='Suggested follows' /></button>
          </div>
          ...
          <SwipeableViews index={index} onChangeIndex={this.handleChangeIndex}>
            ...
            <div className='explore__follows'>
